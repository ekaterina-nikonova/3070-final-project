vocabulary = """
    ...
    あらし;stormy
    何も;anything, has not ... anything, do not ... anything
    ピンク;pink
    ぬいぐるみ;plush toy, plushie, stuffed animal
    キーホルダー;keychain
    マグネット;magnet
    ギフトショップ;gift shop
    フェンス;fence, fences
    ...
    となり;next door, next to, neighboring
    チェックイン;check-in
    かぎ;key
    ネット;internet
    三日;third, three days
    ...
    いらっしゃいませ;welcome
    ウーロンちゃ;oolong tea
    二人;two people, they, two
    なんめいさま;how many people
    メニュー;menu
    四人;four
    つめたい;cold
    タピオカティー;bubble tea
    ...
    せんこう;major
    四年生;senior, seniors
    三年生;third grade student, junior
    サム;Sam
    かい;are you, will you, buy
    二年生;sophomore
    一年生;freshman
    ...
    おてら;temple
    たてもの;building
    な;do not, (adjective ending), don't
    ところ;place
    ほんとうに;really, truly
    ながい;long
    しゅうてん;final stop
    ...
    とおい;far
    でんわ;phone
    ちか;underground level
    タクシー;taxi
    エレベーター;elevator
    おてあらい;restroom
    wifi;wifi
    ありません;there are no, (it) is not, has nothing
    ゴミばこ;trash can
    のりかえ;transfer
    あそこ;over there
    かいさつ;ticket gate
    ありますか;is (there), is (it), are (there)
    いっかい;first floor
    ホーム;platform
    どうが;video
    じゅうどう;judo
    ...
    あたまがいい;smart
    むすこ;my son
    おしゃれ;fashionable, stylish, well-dressed
    むすめ;my daughter
    六;six
    つま;my wife
    ...
    ちず;map
    きっぷ;ticket
    じゃないです;is not, we're not, aren't
    ちかてつ;subway
    くうこう;airport
    はん;thirty
    すみません;excuse me
    ...
    じゃあね;bye
    さん;Mr., Miss, Mrs.
    こんばんは;tonight, good evening, this evening
    なおみ;Naomi
    はな;flowers, flower, Hana
